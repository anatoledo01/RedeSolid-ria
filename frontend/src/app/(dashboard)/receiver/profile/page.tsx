...
import {
  UserCircle, Mail, Phone, Shield, Calendar, Pencil, Save, Loader2,
} from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-2xl overflow-hidden">
        <div className="h-24 bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 relative">
          <div className="absolute -bottom-10 left-6">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white text-3xl font-bold border-4 border-[hsl(var(--card))] shadow-lg">
